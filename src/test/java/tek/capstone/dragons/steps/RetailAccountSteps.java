...
public class RetailAccountSteps extends CommonUtility {
	...
	public void aMessageShouldBeDisplayed(String paymentUpdateSuccessMessage) {
		waitTillPresence(factory.retailAccountPage().paymentUpdateSuccessMessage);
		Assert.assertTrue(isElementDisplayed(factory.retailAccountPage().paymentUpdateSuccessMessage));
